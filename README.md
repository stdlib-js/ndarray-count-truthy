...
```javascript
countTruthy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-count-truthy@v0.1.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/ndarray-count-truthy/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/ndarray-count-truthy/actions/workflows/test.yml?query=branch:v0.1.0
